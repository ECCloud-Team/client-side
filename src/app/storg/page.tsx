                ...
                <div className="flex flex-col items-center mb-6">
                    <div className="w-full p-4 mb-4 rounded-lg bg-blue-50">
                        <div className="mb-4 text-center">
                            <button  className="px-4 py-2 mt-4 text-white bg-blue-500 rounded">Simulate File Upload</button>
                        </div>
                        <div className="mt-6 text-center">
                            <p className="mb-2 text-lg font-bold">Your Storage</p>
                            <div className="flex justify-center"> </div>
                            <p>{(1000 / (1024 * 1024 * 1024)).toFixed(2)} GB are used out of 100 GB</p>
                            <p>{(100 - (1000 / (1024 * 1024 * 1024)).toFixed(2))} % left</p>
                        </div>
                    </div>
                    <div className="mx-2">
                        <button  className="px-4 py-2 mx-2 mt-4 text-white bg-yellow-500 rounded">Stop Service</button>
                        <button  className="px-4 py-2 mx-2 mt-4 text-white bg-red-500 rounded">Terminate Service</button>
                        <Link href="/billing">
                            <button className="px-4 py-2 mx-2 mt-4 text-white bg-green-500 rounded">View Billing</button>
                        </Link>
                ...
                <div className="w-full p-4 mt-8 bg-gray-100 rounded-lg">
                    ...
                    <div className="flex justify-around">
                        <div className="w-1/3 p-4 bg-white rounded-lg shadow-md">
                            ...
                            <button className="px-4 py-2 text-white bg-green-500 rounded">Buy now</button>
                        </div>
                        <div className="w-1/3 p-4 bg-white rounded-lg shadow-md">
